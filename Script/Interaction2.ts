...
import UIController2 from './UIController2';

export default class Interaction2 extends ZepetoScriptBehaviour 
{
    public openUIGesture: Button;
    public openUIGesture2: Button;
    ...
    public failureRatio: number = 1;
    
    private uiController: UIController2;
    ...
    {    
        ...
        // Script import
        this.uiController = this.uiControllerObject.GetComponent<UIController2>();
        
        //Button Hide
        this.openUIGesture.gameObject.SetActive(false);
        this.openUIGesture2.gameObject.SetActive(false);
        ...
        this.openUIGesture2.onClick.AddListener(()=>{
            //this.zepetoCharacter.SetGesture(this.animationClip);
            //this.StartCoroutine(this.FirstRoutine());         
        });
    }
    ...
    OnTriggerEnter(collider)
    {
        ...
        this.openUIGesture2.gameObject.SetActive(true);
    }
