...
import UIController3 from './UIController3';

export default class Interaction3 extends ZepetoScriptBehaviour 
{
    ...
    private uiController: UIController3;
    ...
    {    
        ...
        // Script import
        this.uiController = this.uiControllerObject.GetComponent<UIController3>();
